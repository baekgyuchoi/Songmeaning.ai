...
export const v1songMeaningPrompt = `
...
Please craft an in-depth interpretation exploring the multifaceted emotions and intricate storytelling within the song. Avoid redundancy while presenting a comprehensive analysis.
...
Quote Analysis:
Conduct a quote analysis. 
Choose significant quotes that resonate strongly with the song's essence and analyze them meticulously, aiming for 4 quotes analyzed in total. DO NOT REPEAT QUOTES.
If you have to repeat quotes, reduce the number of quotes returned
