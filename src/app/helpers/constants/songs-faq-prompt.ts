export const songs_faq_prompts = [
    [`Given the song, artist, lyrics, and meaning above: provide 2 songs by this artist that are similar to this song and deeply analyze the similarities in meanings. Please break this analysis down in up to 2 sections for each song .
