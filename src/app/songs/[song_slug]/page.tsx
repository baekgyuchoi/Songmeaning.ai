...
export async function generateMetadata({
  ...
  try{
    ...
    song_description = "Meaning of" + song_title + "lyrics: " + song_db?.song_meaning_preview?.meaning || ""
  }
  catch{
    const song_title = song_slug.split("_").join(" ")
    song_description = "Meaning of " + song_title  + "lyrics - parsed by AI"
  }
                                  ...
                                  <div className='flex flex-col justify-center '>
                                    <div className='text-base sm:ml-1 flex flex-col font-mono items-start'>
                                      {song_data.release_date == "" || song_data.release_date == null ? (
                                        ...
                                        {(is_meaning_valid && !is_meaning_flagged) ? (
                                          <>
