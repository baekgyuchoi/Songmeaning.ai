  ...
  return (
    <div className="flex justify-center w-full md:w-3/5  rounded p-2 transition ">
      <input
        ...
        className="px-5 py-1 sm:px-5 sm:py-3 font-mono flex-1 border-gray-300 text-black bg-gray-100 hover:bg-gray-200 focus:bg-gray-200 rounded-full   placeholder:text-black-400"
