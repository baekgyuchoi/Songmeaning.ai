...
import { FacebookShareButton, TwitterShareButton, LinkedinShareButton, RedditShareButton, RedditIcon, PinterestShareButton, PinterestIcon, FacebookIcon, TwitterIcon, LinkedinIcon, WhatsappShareButton, WhatsappIcon, InstagramIcon } from 'next-share';
...
const ShareContainer: React.FC<ShareContainerProps> = (props) => {
    const [isCopied, setIsCopied] = React.useState(false);
    const song_url = `https://songmeaning.ai/songs/${props.song_slug}`
    return (
        <div className='text-black border-1 border-b-2 border-purple-800/25 bg-gray-50 rounded-md flex flex-col items-center p-4 mt-8'>
